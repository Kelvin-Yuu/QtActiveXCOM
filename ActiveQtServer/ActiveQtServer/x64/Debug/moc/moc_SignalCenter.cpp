...
void SignalCenter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SignalCenter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->out_rec((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SignalCenter::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject SignalCenter::staticMetaObject = { {
    ...
    qt_meta_stringdata_SignalCenter.data,
    qt_meta_data_SignalCenter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SignalCenter::out_rec(QString _t1)
{
